 ...
 *	@Return non zero if successfully.
 */
extern int arpsc_init_iface_attrb(const struct ifaddrs *__restrict__ tmp, iFaceAttr *__restrict__ attr);
 ...
 *
 */
extern void arpsc_print_arp_format(const char *__restrict__ pformat, iFaceAttr *__restrict__ iface,
